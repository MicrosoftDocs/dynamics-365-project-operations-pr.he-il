...
---
# <a name="project-service-automation-v3-update-release-15"></a>מהדורה 15, עדכון V3 של Project Service Automation
...
- זמן והוצאה
  ...
  - תוקן: מרכז משאבי הפרוייקט: שינוי שם **כמות** כדי להפחית את העמימות.
...
- ניהול פרוייקט
  ...
  - תוקן: באנר התראות חדש נוסף לטופס הפרוייקט כאשר אזור הזמן של המשתמש שונה מזה של הפרוייקט.
