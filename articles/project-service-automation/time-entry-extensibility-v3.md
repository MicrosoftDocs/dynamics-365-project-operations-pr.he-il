...
---
# <a name="customize-weekly-time-entry"></a>התאמה אישית של הזנת ערכי זמן שבועית 
...
> [!NOTE] 
> שתי האפשרויות יסירו סינון מסוים הנכלל מראש בישויות **פרוייקט** ו**משימת פרוייקט**, כך שכל תצוגות בדיקת המידע של הישויות יהיו גלויות. ההגדרה שנקבעה מראש מציגה רק את תצוגות בדיקת המידע הרלוונטיות.
