...
חבר צוות פרוייקט או אדם אחר השולח ערך זמן או הוצאה יכול לאחזר את ערך הזמן או ההוצאה לאחר אישורו. התהליך לאחזור ערך זמן או הוצאה שאושר כולל שני שלבים:
...
1. עבור ערכי זמן, עבור אל **פרוייקטים** \> **העבודה שלי** \> **ערך זמן**.

    -לחלופין-

    עבור ערכי הוצאה, עבור אל **פרוייקטים** \> **העבודה שלי** \> **הוצאות**.

2. עבור ערכי זמן, בחר את כל ערכי הזמן עבור שילוב מסוים של פרוייקט ומשימה. לחלופין, ברשת, בחר את התאים הבודדים עבור זמן בתאריך מסוים, עבור פרוייקט ספציפי.
...
חבר צוות הפרוייקט יכול להציג ערכים, לערוך ולאחר מכן לשלוח מחדש ערכים, או למחוק ערכים באופן מלא.

אם בקשת אחזור נדחתה, הערך נשאר במצב **אושר** וחבר צוות הפרוייקט או המאשר של הפרוייקט לא יכולים לערוך את הערך.
...
אם בקשת אחזור נדחית, אין לכך השפעה פיננסית על הפרוייקט.
