---
title: פרטי כותרת להצעות מחיר לפרוייקט
description: מאמר זה מספק מידע על המידע וההגדרות החלים על הצעות מחיר של פרויקטים ומשפיעים עליהן. (Sales)
author: rumant
ms.date: 10/01/2020
ms.topic: article
