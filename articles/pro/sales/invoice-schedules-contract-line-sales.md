...
---
# <a name="creating-invoice-schedules-on-a-project-based-contract-line"></a>יצירת לוחות זמנים של חשבונית בסעיף חוזה מבוסס פרויקט
...
כאשר בסעיף חוזה יש שיטת חיוב קבועה, ניתן ליצור לוח זמנים של חשבונית שמבוסס על אבני דרך. בצע את השלבים הבאים כדי ליצור לוח זמנים לחשבונית המבוססת על אבני דרך המחולקות באופן שווה לאורך התקופה הקלנדרית.
...
3. בחר **שמור וסגור**.
| סכום שורה | יצירה מהירה | הסכום או הערך של ציון הדרך שיחויב ללקוח | מועבר לציון דרך בסעיף חוזה בפרויקט ולחשבונית | מס | יצירה מהירה | סכום מס שיוחל על ציון הדרך | מועבר לציון דרך בסעיף חוזה בפרויקט ולחשבונית |
