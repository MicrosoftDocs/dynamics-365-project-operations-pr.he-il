---
title: מבט כולל על שורות חוזה פרוייקט
description: מאמר זה מספק מידע על עבודה עם שורות חוזה פרויקט ב- Project Operations.
author: rumant
ms.date: 10/28/2020
ms.topic: overview
...
ms.locfileid: "9824627"
---
# <a name="project-contract-lines-overview"></a>מבט כולל על שורות חוזה פרוייקט
