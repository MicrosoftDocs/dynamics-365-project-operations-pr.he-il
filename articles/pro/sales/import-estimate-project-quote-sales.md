---
title: ייבוא הערכות מפרוייקט לשורת הצעת מחיר של פרוייקט
description: מאמר זה מספק מידע על אופן יבוא אומדנים מפרויקט לשורת הצעת מחיר בפרויקט.
author: rumant
ms.date: 10/09/2020
ms.topic: article
...
ms.locfileid: "9824487"
---
# <a name="import-estimates-from-a-project-to-a-project-quote-line"></a>ייבוא הערכות מפרוייקט לשורת הצעת מחיר של פרוייקט 
