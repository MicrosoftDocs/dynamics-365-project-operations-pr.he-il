---
title: ניהול לקוחות מרובים בשורות הצעות מחיר בפרוייקט
description: מאמר זה מתאר את אופן הניהול של מספר לקוחות בשורת הצעת מחיר בפרויקט.
author: rumant
ms.date: 10/06/2020
ms.topic: article
