...
| אספקת השדרוג | שלב 1 (ינואר 2022) | שלב 2 (גל אפריל 2022) | שלב 3 (גל אפריל 2022) |
|------------------|------------------------|---------------------------|---------------------------|
...
| אימותים | שלב 1 (ינואר 2022) | שלב 2 (גל אפריל 2022) | שלב 3 (גל אפריל 2022) |
|-------------|------------------------|---------------------------|---------------------------|
...
| ה-WBS יאומת כנגד המגבלות הידועות של Project Desktop Client. | | :heavy_check_mark: | :heavy_check_mark: |
...
- יש לעדכן את סביבת היעד ל-Project Service Automation מהדורת עדכון 38 ואילך.
...
## <a name="end-to-end-testing-in-lower-environments"></a>בדיקות מקצה לקצה בסביבות נמוכות יותר

### <a name="run-the-upgrade-in-production"></a>הפעל את השדרוג בייצור
...
| Dynamics 365 Finance ניהול פרוייקטים וחשבונאות | פריסת לייט של Project Operations                        | נכון לעכשיו לא נתמך |
