...
description: מאמר זה מספק מידע על הוספת שדות מותאמים אישית להגדרת מחיר וישויות של עסקאות.
author: Rumant
ms.custom:
...
‏‫מאמר זה יוצא מנקודת הנחה שהשלמת את ההליכים שמופיעים במאמר, [‬‏‫יצירת שדות וישויות מותאמים אישית‬‏‫](create-custom-fields-entities.md). אם לא השלמת הליכים אלה, חזור והשלם אותם ולאחר מכן חזור למאמר זה. 
...
בשלבי המכירות וההערכה בפרויקט, הערכות של מאמץ העבודה שנדרש כדי להשלים עבודה **באופן מקומי** ועבודה **באתר הלקוח**, ב **שעות רגילות** וב **שעות נוספות**  משמשים כדי להעריך את הערך של הצעת המחיר/הפרויקט. השדות **מיקום עבודה של משאב** ו **שעות עבודה של משאב** יתווספו אל ישויות הערכה, **‏‫פרטים בשורת הצעת מחיר‬**, **פרטים בסעיף חוזה**, ‏‫**משימה בפרויקט**, **חבר צוות פרויקט‬** ו **‏‫שורת הערכה‬**.
