...
description: מאמר זה מספק מידע על האופן שבו ניתן להשתמש בממדים של תמחור כדי לתמוך בתמחור ובתמחיר עבור משאב הממלא תפקידים מרובים בפרויקט.
author: rumant
ms.custom:
