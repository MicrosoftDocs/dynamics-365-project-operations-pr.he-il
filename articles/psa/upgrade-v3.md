...
description: מאמר זה מספק מידע על השיקולים הדרושים בעת השדרוג מגירסה ‎2.x או ‎1.x של Project Service Automation לגרסה 3.
ms.prod: ''
ms.custom:
...
שינויים אלה משפיעים על השדרוג של כל הפרויקטים הקיימים שיש להם הקצאות משאבים עבור משאבים בעלי שם הניתנים להזמנה ומשאבים כלליים בצוות הפרויקט. מאמר זה מספק את הנושאים שעליך לשקול עבור הפרויקטים בעת השדרוג לגירסה 3. 
