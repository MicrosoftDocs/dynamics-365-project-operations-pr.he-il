---
title: התאמה אישית של ערכי זמן שבועיים
description: מאמר זה מספק מידע על אופן היישום של כללים עסקיים מותאמים אישית התומכים בנוהלי הארגון.
author: stsporen
ms.custom:
...
המקטע **ממדים** אינו מאפשר עריכה בתוך השורה. מקטע זה מגובה על-ידי תצוגה המאפשרת להוסיף שדות מותאמים אישית לרשת הזנת הזמן השבועית. לקבלת מידע על הוספת שדות מותאמים אישית, עיין בסעיף 'יכולת הרחבה' בהמשך מאמר זה.
