...
description: נושא זה מסביר כיצד להגדיר כיצד נתוני ברירת מחדל מוזנים בעת שילוב Microsoft Dynamics 365 for Project Service Automation עם ‏‏‎‎365 Finanace‎‏ Microsoft Dynamics.
author: ruhercul
ms.date: 03/03/2020
ms.topic: article
ms.prod: ''
