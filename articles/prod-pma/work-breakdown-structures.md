...
בניית WBS היא תהליך אינטנסיבי שבדרך כלל נעשה לאורך תקופה ארוכה, ודורש שיתוף פעולה ומידע ממגוון רחב של אנשים. מאמר זה מתאר כיצד להשתמש בשיפורי WBS כדי לעמוד בדרישות שלך לאומדנים ומעקב.
...
מאמץ = מספר אנשים x משך זמן x שעות ביום עבודה רגיל בלוח השנה של הפרויקט. 
...
תצוגת התכנון מציגה את האומדן המתוכנן או הבסיסי של לוח הזמנים ומידע העלויות. למרות שאין תכונות למעקב אחר הגרסה וקו הבסיס לפרויקט WBS, הערכים בתצוגה זו מיועדים לייצג את גרסת הבסיס. המקטעים הערכת לוח זמנים ואומדן עלויות במאמר זה מתארים תצוגה זו וכיצד היא משמשת ליצירת WBS.
