---
title: ניהול הזדמנויות פרוייקט
description: מאמר זה מספק מידע על אופן העבודה עם הזדמנויות הקשורות לפרויקטים.
author: rumant
ms.date: 10/21/2020
ms.topic: article
...
ms.locfileid: "9825304"
---
# <a name="manage-project-opportunities"></a>ניהול הזדמנויות פרוייקט
...
הזדמנויות שמבוססות על פרויקטים ב- Dynamics 365 Project Operations תוכננו עם הרחבות ל- Dynamics 365 Sales. המאמר מספק פרטים על סוגי הלוגיקה העסקית והשדות השונים הכלולים בפונקציונליות הנוספת הנדרשת על ידי חברות מבוססות פרויקטים, לניהול הזדמנויות מבוססות פרויקטים.
