---
title: יצירת לוחות זמנים של חשבונית בסעיף חוזה מבוסס פרוייקט
description: מאמר זה מספק מידע על אופן יצירת לוחות זמנים של חשבוניות ואבני דרך בסעיפי חוזה.
author: rumant
ms.date: 10/17/2020
ms.topic: article
...
ms.locfileid: "9825098"
---
# <a name="create-invoice-schedules-on-a-project-based-contract-line"></a>יצירת לוחות זמנים של חשבונית בסעיף חוזה מבוסס פרוייקט
