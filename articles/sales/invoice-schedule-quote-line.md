---
title: לוחות זמנים של חשבוניות בשורות הצעת מחיר של פרויקט
...
## <a name="create-a-fixed-price-invoice-schedule-for-a-project-quote-line"></a>יצירת לוח זמנים לחשבונית מחיר עבור שורת הצעת מחיר של פרויקט
