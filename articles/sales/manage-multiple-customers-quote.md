---
title: ניהול מספר רב של לקוחות הצעת מחיר מבוססות פרויקט
...
ms.locfileid: "9825149"
---
# <a name="manage-multiple-customers-on-a-project-based-quote"></a>ניהול מספר רב של לקוחות הצעת מחיר מבוססות פרויקט

_**חל על:** ‏Project Operations לתרחישים מבוססי משאבים/ללא מלאי_

הצעות מחיר מבוססות פרויקט תומכות בתרחיש שבו ההצעה כוללת מספר לקוחות שיממנו את העסקה. הכרטיסיה **סיכום** של הצעת המחיר כוללת את השדה **לקוח פוטנציאלי**, שמזהה את הלקוח העיקרי של העסקה. אפשר להגדיר לקוחות אחרים בעסקה יכולים בכרטיסיה **לקוחות** של הצעת המחיר לפרויקט.
