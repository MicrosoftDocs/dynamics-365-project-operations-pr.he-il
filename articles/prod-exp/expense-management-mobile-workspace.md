...
description: מאמר זה מספק מידע על סביבת העבודה במכשירים ניידים של ניהול הוצאות. מרחב עבודה זה מאפשר למשתמשים לאסוף ולהעלות קבלה, כך שהם יוכלו לצרף אותה לדוח הוצאות מאוחר יותר. משתמשים יכולים גם ליצור שורת הוצאות במהירות באמצעות קבלה מצורפת, וליצור ולנהל את דוחות ההוצאות שלהם.
author: suvaidya
ms.date: 12/01/2017
ms.topic: article
...
- צלם תמונה של קבלה והעלה אותה אל Dynamics 365 Finance. תוכל לצרף תמונה זו לדוח הוצאות מאוחר יותר.
...
## <a name="download-and-install-the-dynamics-365-for-operations-mobile-app"></a>הורדת האפליקציה למכשירים ניידים Dynamics 365 for Operations והתקנתו
...
5. לאחר הכניסה, סביבות העבודה הזמינות עבור החברה שלך מוצגות. שים לב, אם מנהל המערכת מפרסם סביבת עבודה חדשה מאוחר יותר, יהיה עליך לרענן את רשימת סביבות העבודה הניידות.
