...
description: מאמר זה מספק מידע על איך להקצות סביבת Project Operations חדשה.
author: sigitac
ms.date: 09/13/2021
ms.topic: article
ms.prod: ''
...
מאמר זה מספק מידע על אופן הקצאת סביבת Dynamics 365 Project Operations חדשה עבור תרחישים מבוססי משאבים/ללא מלאי.
